% This function is to calibrate the distributed scheme of the hydrological emulator (HE) 
% agaist the targe global hydrological model (GHM) to get optimized parameters (a,b,c,d,m)

function [pars] = Calibration_dist(PET,P,TMIN,Robs,BFI)  
    ...
    pars=ga(@(pars)ObjFun_abcd_dist(pars,P0,PET0,Robs0,Inv0,TMIN0,BFI),nn,[],[],[],[],LB,UB);  